 ...
 */
			...
			function loadMap() {
				...
				gltfLoader.load('/gltf/goethe_basemap.glb', (gltf) => {
			...
			function init() {
				...
				for ( let i = 0; i < table.length; i ++ ) {
					...
					;
					//element.style.backgroundColor = 'rgb(231, 230, 230, 0.5)';
					element.setAttribute("onclick", "window.open(' " + table[i].propyURL +"')");

					// <div class="id">
					const id = document.createElement( 'div' );
					id.className = 'id';
					id.textContent = table[i].idFormatted;
					element.appendChild( id );

					// <div class="initials">
					const initials = document.createElement( 'div' );
					initials.className = 'initials';
					initials.textContent = table[i].receiverInitials;
					initials.setAttribute("onclick", "window.open(' " + table[i].receiverId +"')");
					element.appendChild( initials );

					// <div class="name">
					const name = document.createElement( 'div' );
					name.className = 'name';
					name.innerHTML = table[i].receiverFormatted ;
					name.setAttribute("onclick", "window.open(' " + table[i].receiverId +"')");
					element.appendChild( name );

					// <div class="date">
					const date = document.createElement( 'div' );
					date.className = 'date';
					date.innerHTML = table[i].dateFormatted;
				...
				/* 
				1. 2x groupBy (Ramda) nach Orten (sent und received), 
				zwei Arrays erstellen, 
				dann neue property (ob Ort Absendeort oder Empfangsort war) 
				und dann mergen
				2. groupBy nach Zeit
				3. Iteration über Zeitobjekte
				4. Sphären pro Zeitabschnitt erstellen
				 */
...
/* 				 for (let i = minDate; i <= maxDate; i + step ){
				...
				*/
				...
				// Funktion für Sphärenerstellung: array wird übergeben, aus Elementen im Array wird eine Sphäre gemacht
				
				const createSphere = (array) => {
