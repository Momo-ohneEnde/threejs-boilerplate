...
// + MeshBasicMaterial
const europeNormalTexture = textureloader.load(
  "/textures/Europe/NormalMap.png"
);
const europeDisplacementTexture = textureloader.load(
  "/textures/Europe/DisplacementMap.png"
);
...
const loader = new STLLoader();
const goethe = loader
  .loadAsync("/STLs/Goethe_bust.stl")
  .then((geometry) => {
    var axesHelper = new THREE.AxesHelper(20);
    scene.add(axesHelper);
    return geometry;
